import { Camera, Clock, MapPin, MessageCircle, Truck } from "lucide-react";
      ...
      <div className="container-page">
        ...
        <ul className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          {contact.address ? (
            ...
            <li className="rounded-card border border-ink/10 bg-card p-5">
              <Truck aria-hidden="true" className="size-5 text-olive" />
              <h3 className="mt-3 font-display text-base font-semibold text-ink">
                Entrega y retiro
              </h3>
              <p className="mt-1 text-sm text-bark">
                Coordinamos por WhatsApp el punto y el horario que te quede cómodo.
              </p>
            </li>
          )}
